...
$foto = $_SESSION['foto'] ?? 'https://via.placeholder.com/100'; // Imagem padrão se não houver foto
    ...
    <div class="sidebar p-3" id="sidebar">
        <div class="card mb-3" style="width: 100%;">
            <div class="card-body text-center">
                ...
                <h5 class="card-title"><?php echo htmlspecialchars($usuario); ?></h5><!-- Nome do usuário -->
                <p class="card-text"><?php echo htmlspecialchars($email); ?></p><!-- Email do usuário -->
            </div>
        </div>
